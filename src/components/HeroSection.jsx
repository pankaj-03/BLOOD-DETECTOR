        ...
        <>
            ...
            <div>
                <div className="bg-[url('/src/assets/background_image.png')] bg-cover bg-center min-h-screen p-3">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center xl:gap-50 md:gap-15 gap-50 mt-30">
                        <img src={fingerprintImg} alt="fingerprintImage" className="xl:w-[300px] xl:h-[300px] md:w-[200px] md:h-[200px] w-[250px] h-[250px] object-cover hover:scale-105 transition-transform duration-300 rounded-xl shadow-lg"
                        ></img>
                        <img src={aianalysis} alt="fingerprintImage" className="xl:w-[300px] xl:h-[300px] md:w-[200px] md:h-[200px] w-[250px] h-[250px]  object-cover hover:scale-105 transition-transform duration-300 rounded-xl shadow-lg"
                        ></img>
                        <img src={getres} alt="fingerprintImage" className="xl:w-[300px] xl:h-[300px] md:w-[200px] md:h-[200px] w-[250px] h-[250px]  object-cover hover:scale-105 transition-transform duration-300 rounded-xl shadow-lg"
                        ></img>
                    </div>
